#!/usr/bin/env bash
# ===============================================================
# SRA — Skill Runtime Advisor 一键安装脚本 v1.3.0
# ===============================================================
# 用法:
...
SKIP_PIP=false
PROXY_MODE=false     # v1.3.0: Proxy 模式（消息前置推理中间件）
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --help)
            echo "SRA — Skill Runtime Advisor 一键安装脚本 v1.3.0"
            echo
            echo "选项:"
...
# ── 步骤 1: 检查环境 ──────────────────────
echo "=============================================="
echo "  SRA -- Skill Runtime Advisor v1.3.0"
echo "=============================================="
echo
...
if [[ "$SKIP_PIP" != "true" ]]; then
    ...
    if command -v sra &>/dev/null; then
        ok "sra CLI 安装成功: $(sra version 2>/dev/null || echo 'v1.3.0')"
    else
...
echo
echo "=============================================="
echo -e "${GREEN}  ✅ SRA v1.3.0 安装完成！${NC}"
echo "=============================================="
echo
echo "📋 安装后自检："
